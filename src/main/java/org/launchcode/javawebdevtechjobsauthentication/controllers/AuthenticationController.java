...
public class AuthenticationController {
    ...
    public String processLoginForm(@ModelAttribute @Valid LoginFormDTO loginFormDTO,
        ...
        if (existingUser == null) {
            errors.rejectValue("username", "username.doesnotexist", "A user with that username does not exist");
            model.addAttribute("title", "Login");
            return "login";
        }
        ...
        if (!existingUser.isMatchingPassword(submittedPassword)) {
            errors.rejectValue("password", "username.incorrectpassword", "That password is incorrect!");
            model.addAttribute("title", "Login");
            return "login";
        }
